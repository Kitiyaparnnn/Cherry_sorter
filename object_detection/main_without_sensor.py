...
# --- Servo Setup ---
init_time = 60 * 1 # wait for 5 mins until first sorting
delay_time = 0.5 # wait for 0.5 sec to next prediction
...
delay = 0.5 # wait for 0.5 sec to detect next frame
min_conf = 0.7 # minimum confidential classification
